 ...
 // console.log('hi me in admin psa')
  ...
  const updateEquipment = async (data) => {
    ...
    try {
      ...
      window.location.href = "/admin/psa/list";
    } catch (error) {
            ...
            <Grid sx={{ width: '20%' }}>
              <Stack spacing={2}>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <CheckBox name="isactive" label="Active" checked={equipmentData.is_active || false} onChange={handleChangeCheckbox} />
                </Stack>
              </Stack>
            </Grid>
