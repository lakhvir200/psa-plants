...
import ModalPopup from "../components/DialogPopup";
  ...
  return (
    <Box p={4}>
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={2}>
        <Typography variant="h5">PSA List</Typography>
        <Button variant="contained" onClick={handleOpenModal}>Add New</Button>
      </Stack>

      {/* Dummy data list */}
      <Paper sx={{ p: 2, mb: 1 }}>Item 1</Paper>
      <Paper sx={{ p: 2, mb: 1 }}>Item 2</Paper>
      <Paper sx={{ p: 2, mb: 1 }}>Item 3</Paper>

      {/* Modal Popup */}
      <ModalPopup open={open} onClose={handleCloseModal} title="Welcome">
        <Typography>Welcome to the PSA modal!</Typography>
      </ModalPopup>
    </Box>
  );
}
